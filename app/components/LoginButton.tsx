...
if (session) {
    return (
        <div className="dropdown cursor-pointer bg-slate-700 self-center pl-4 pr-4 inline-block relative w-24 rounded-md hover:rounded-b-none transition-all ease-linear duration-300">
            {session.user?.name}
